...
import './App.css';
import img_elDrillDrownCopy from './images/AllowanceScreen_elDrillDrownCopy.jpg';
...
export default class AllowanceScreen extends Component {
  ...
  render() {
    ...
    const style_drillDrownCopy = {
        backgroundImage: 'url('+img_elDrillDrownCopy+')',
    ...
    return (
      <div className="AppScreen AllowanceScreen" style={baseStyle}>
        <div className="screenFgContainer">
          <div className="foreground">
            <div className='containerMinHeight elDrillDrownCopy' style={style_drillDrownCopy} />
